...
### 连续对话提问
1. **选中文本**: 选择要咨询的文本内容
2. **点击提问**: 按 `Ctrl+Q` 后点击 "❓ 提问" 按钮
3. **输入问题**: 在弹出的对话框中输入你的问题
4. **继续对话**: 点击 "❓ 提问" 按钮可以继续基于同一文本提问
5. **多轮交互**: 系统会自动维护对话历史，支持上下文理解

### 智能工作流
1. **使用工作流**: 选择文本后，系统支持智能工作流处理
2. **链式处理**: 如 "翻译→解释→总结" 自动顺序执行
3. **条件触发**: 根据文本长度和内容自动选择处理步骤
